...
class IWFMMiscellaneous:
    ...
    def get_data_unit_type_id_length(self):
        ...
        self.dll.IW_GetDataUnitTypeID_Length(ctypes.byref(length_unit_id),
                                             ctypes.byref(status))
    ...
    def get_data_unit_type_id_area(self):
        ...
        self.dll.IW_GetDataUnitTypeID_Area(ctypes.byref(area_unit_id),
                                             ctypes.byref(status))
    ...
    def get_data_unit_type_volume(self):
        ...
        self.dll.IW_GetDataUnitTypeID_Volume(ctypes.byref(volume_unit_id),
                                             ctypes.byref(status))
    ...
    def get_data_unit_type_ids(self):
        ...
        self.dll.IW_GetDataUnitTypeIDs(ctypes.byref(length_unit_id),
                                       ctypes.byref(area_unit_id),
                                       ctypes.byref(volume_unit_id),
                                       ctypes.byref(status))

        return dict(length=length_unit_id.value,
    ...
    def get_land_use_type_id_gen_ag(self):
        ...
        self.dll.IW_GetLandUseTypeID_GenAg(ctypes.byref(gen_ag_landuse_id),
                                           ctypes.byref(status))
    ...
    def get_land_use_type_id_urban(self):
        ...
        self.dll.IW_GetLandUseTypeID_Urban(ctypes.byref(urban_landuse_id),
                                           ctypes.byref(status))
    ...
    def get_land_use_type_id_nonponded_ag(self):
        ...
        self.dll.IW_GetLandUseTypeID_NonPondedAg(ctypes.byref(nonponded_ag_landuse_id),
                                                 ctypes.byref(status))
    ...
    def get_land_use_type_id_rice(self):
        ...
        self.dll.IW_GetLandUseTypeID_Rice(ctypes.byref(rice_landuse_id),
                                                 ctypes.byref(status))
    ...
    def get_land_use_type_id_refuge(self):
        ...
        self.dll.IW_GetLandUseTypeID_Refuge(ctypes.byref(refuge_landuse_id),
                                            ctypes.byref(status))
    ...
    def get_land_use_type_id_native_riparian(self):
        ...
        self.dll.IW_GetLandUseTypeID_NVRV(ctypes.byref(nvrv_landuse_id),
                                            ctypes.byref(status))
    ...
    def get_land_use_ids(self):
        ...
        self.dll.IW_GetLandUseTypeIDs(ctypes.byref(gen_ag_landuse_id),
        ...
        return dict(genag=gen_ag_landuse_id.value,
    ...
    def get_location_type_id_node(self):
        ...
        self.dll.IW_GetLocationTypeID_Node(ctypes.byref(location_type_id_node),
                                           ctypes.byref(status))
    ...
    def get_location_type_id_element(self):
        ...
        self.dll.IW_GetLocationTypeID_Element(ctypes.byref(location_type_id_element),
                                              ctypes.byref(status))
    ...
    def get_location_type_id_subregion(self):
        ...
        self.dll.IW_GetLocationTypeID_Subregion(ctypes.byref(location_type_id_subregion),
                                                ctypes.byref(status))
    ...
    def get_location_type_id_zone(self):
        ...
        self.dll.IW_GetLocationTypeID_Zone(ctypes.byref(location_type_id_zone),
                                           ctypes.byref(status))
    ...
    def get_location_type_id_streamnode(self):
        ...
        self.dll.IW_GetLocationTypeID_StrmNode(ctypes.byref(location_type_id_streamnode),
                                               ctypes.byref(status))
    ...
    def get_location_type_id_streamreach(self):
        ...
        self.dll.IW_GetLocationTypeID_StrmReach(ctypes.byref(location_type_id_streamreach),
                                                ctypes.byref(status))
    ...
    def get_location_type_id_lake(self):
        ...
        self.dll.IW_GetLocationTypeID_Lake(ctypes.byref(location_type_id_lake),
                                           ctypes.byref(status))
    ...
    def get_location_type_id_smallwatershed(self):
        if not hasattr(self.dll, "IW_GetLocationTypeID_SmallWatershed"):
           raise AttributeError('IWFM DLL does not have "{}" procedure. '
                                 'Check for an updated version'.format('IW_GetLocationTypeID_SmallWatershed'))

        # initialize output variables
        location_type_id_smallwatershed = ctypes.c_int(0)
        status = ctypes.c_int(0)

        self.dll.IW_GetLocationTypeID_SmallWatershed(ctypes.byref(location_type_id_smallwatershed),
                                                     ctypes.byref(status))
    ...
    def get_location_type_id_gwheadobs(self):
        ...
        self.dll.IW_GetLocationTypeID_GWHeadObs(ctypes.byref(location_type_id_gwheadobs),
                                                ctypes.byref(status))
    ...
    def get_location_type_id_streamhydobs(self):
        ...
        self.dll.IW_GetLocationTypeID_StrmHydObs(ctypes.byref(location_type_id_streamhydobs),
                                                 ctypes.byref(status))
    ...
    def get_location_type_id_subsidenceobs(self):
        if not hasattr(self.dll, "IW_GetLocationTypeID_SubsidenceObs"):
           raise AttributeError('IWFM DLL does not have "{}" procedure. '
                                 'Check for an updated version'.format('IW_GetLocationTypeID_SubsidenceObs'))

        # initialize output variables
        location_type_id_subsidenceobs = ctypes.c_int(0)
        status = ctypes.c_int(0)

        self.dll.IW_GetLocationTypeID_SubsidenceObs(ctypes.byref(location_type_id_subsidenceobs),
                                                    ctypes.byref(status))
    ...
    def get_location_type_id_tiledrainobs(self):
        if not hasattr(self.dll, "IW_GetLocationTypeID_TileDrainObs"):
           raise AttributeError('IWFM DLL does not have "{}" procedure. '
                                 'Check for an updated version'.format('IW_GetLocationTypeID_TileDrainObs'))

        # initialize output variables
        location_type_id_tile_drain = ctypes.c_int(0)
        status = ctypes.c_int(0)

        self.dll.IW_GetLocationTypeID_TileDrainObs(ctypes.byref(location_type_id_tile_drain),
                                                   ctypes.byref(status))
    ...
    def get_location_type_id_streamnodebud(self):
        if not hasattr(self.dll, "IW_GetLocationTypeID_StrmNodeBud"):
           raise AttributeError('IWFM DLL does not have "{}" procedure. '
                                 'Check for an updated version'.format('IW_GetLocationTypeID_StrmNodeBud'))

        # initialize output variables
        location_type_id_streamnodebud = ctypes.c_int(0)
        status = ctypes.c_int(0)

        self.dll.IW_GetLocationTypeID_StrmNodeBud(ctypes.byref(location_type_id_streamnodebud),
                                                  ctypes.byref(status))
    ...
    def get_location_type_ids(self):
        ...
        self.dll.IW_GetLocationTypeIDs(ctypes.byref(location_type_id_nodes),
        ...
        return dict(nodes=location_type_id_nodes.value,
    ...
    def get_flow_destination_type_id_outside(self):
        ...
        self.dll.IW_GetFlowDestTypeID_Outside(ctypes.byref(flow_destination_type_id),
                                              ctypes.byref(status))
    ...
    def get_flow_destination_type_id_element(self):
        ...
        self.dll.IW_GetFlowDestTypeID_Element(ctypes.byref(flow_destination_type_id),
                                              ctypes.byref(status))
    ...
    def get_flow_destination_type_id_elementset(self):
        ...
        self.dll.IW_GetFlowDestTypeID_ElementSet(ctypes.byref(flow_destination_type_id),
                                                 ctypes.byref(status))
    ...
    def get_flow_destination_type_id_gwelement(self):
        ...
        self.dll.IW_GetFlowDestTypeID_GWElement(ctypes.byref(flow_destination_type_id),
                                                ctypes.byref(status))
    ...
    def get_flow_destination_type_id_streamnode(self):
        ...
        self.dll.IW_GetFlowDestTypeID_StrmNode(ctypes.byref(flow_destination_type_id),
                                               ctypes.byref(status))
    ...
    def get_flow_destination_type_id_lake(self):
        ...
        self.dll.IW_GetFlowDestTypeID_Lake(ctypes.byref(flow_destination_type_id),
                                           ctypes.byref(status))
    ...
    def get_flow_destination_type_id_subregion(self):
        ...
        self.dll.IW_GetFlowDestTypeID_Subregion(ctypes.byref(flow_destination_type_id),
                                                 ctypes.byref(status))
    ...
    def get_flow_destination_type_id(self):
        ...
        self.dll.IW_GetFlowDestTypeIDs(ctypes.byref(flow_destination_type_id_outside),
        ...
        return dict(outside=flow_destination_type_id_outside.value,
    ...
    def get_supply_type_id_diversion(self):
        ...
        self.dll.IW_GetSupplyTypeID_Diversion(ctypes.byref(supply_type_id),
                                              ctypes.byref(status))
    ...
    def get_supply_type_id_well(self):
        ...
        self.dll.IW_GetSupplyTypeID_Well(ctypes.byref(supply_type_id),
                                         ctypes.byref(status))
    ...
    def get_supply_type_id_elempump(self):
        ...
        self.dll.IW_GetSupplyTypeID_ElemPump(ctypes.byref(supply_type_id),
                                             ctypes.byref(status))
    ...
    def get_zone_extent_id_horizontal(self):
        ...
        self.dll.IW_GetZoneExtentID_Horizontal(ctypes.byref(zone_extent_id),
                                               ctypes.byref(status))
    ...
    def get_zone_extent_id_vertical(self):
        ...
        self.dll.IW_GetZoneExtentID_Vertical(ctypes.byref(zone_extent_id),
                                             ctypes.byref(status))
    ...
    def get_zone_extent_ids(self):
        ...
        return dict(horizontal=zone_extent_id_horizontal.value,
    ...
    def get_budget_type_ids(self):
        ...
        self.dll.IW_GetBudgetTypeIDs(ctypes.byref(budget_type_id_gw),
        ...
        return dict(gw=budget_type_id_gw.value,
    ...
    def increment_time(self, date_string, time_interval, n_intervals):
        ...
        self.dll.IW_IncrementTime(ctypes.byref(len_date_string),
                                  date_string,
    ...
    def set_log_file(self, file_name='message.log'):
        ...
        self.dll.IW_SetLogFile(ctypes.byref(len_file_name),
                               file_name,
                               ctypes.byref(status))
    ...
    def get_last_message(self):
        ...
        self.dll.IW_GetLastMessage(ctypes.byref(length_message),
                                   last_message,
                                   ctypes.byref(status))
    ...
    def _string_to_list_by_array(self, in_string, starting_position_array, length_output_list):
