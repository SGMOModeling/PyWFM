...
class IWFM_Budget:
    ...
    def open_budget_file(self):
        ''' opens a budget file generated by an IWFM model application to retrieve data '''
    ...
    def get_values(self, location_id, columns='all', begin_date=None, 
        ...
        # np.array('1899-12-30', dtype='datetime64') + np.array(output_dates, dtype='timedelta64[D]')
